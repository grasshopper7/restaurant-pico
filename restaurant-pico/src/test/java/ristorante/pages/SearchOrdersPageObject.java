...
public class SearchOrdersPageObject extends HomeFramePageObject<SearchOrdersPageObject>  implements SwitchScreen {
	...
	public SearchOrdersPageObject(PageFrameSwitcher frameSwitcher, HomePageObject homePO) {
	...
	public boolean orderPresentInSearch(String tableNo, String orderNo, OrderStatus status) {
	...
	public void selectOrderInSearch(String tableNo, String orderNo, OrderStatus status) {
		...
		driver.findElement(By.xpath("//ul[@id='results']/li/div/a[.='" + line + "']")).click();
	}
}
