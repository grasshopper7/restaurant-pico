...
public class HomePageObject extends BasePageObject<HomePageObject> {
	...
	public HomePageObject(PageFrameSwitcher frameSwitcher) {
		super(frameSwitcher);
	...
	protected void switchScreen(BasePageObject<?> finalPage) {
		...
		if(HomeFramePageObject.class.isAssignableFrom(finalPage.getClass())) {
			...
			waitDriver.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(((HomeFramePageObject)finalPage).getFrameId()));
		} 
